...
func (s *InvoiceService) GetInvoicesByUserID(ctx context.Context, userID int) ([]repository.InvoiceDetail, error) {
	return s.invoiceRepository.GetInvoicesByUserID(ctx, userID)
}
